                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php echo "<a  class='disabled' href='manage-user.php?del=". $result->id ."&name=".$result->fname."' title='Delete Record' data-toggle='tooltip'  onClick=\"javascript:return confirm('are you sure you want to delete this?');\" ><span class='glyphicon glyphicon-trash'></span></a>"; ?>
                        </td>
