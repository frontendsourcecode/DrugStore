			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<h3 class="text-center text-bold text-light mt-4x">Admin Login</h3>
						...
						<div class="well row pt-2x pb-3x bk-light">
							...
							<div class="col-md-8 col-md-offset-2">
								...
								<form method="post">
									...
									<button class="btn btn-primary btn-block" name="login" type="submit" style="    background-color: #009EFF;">LOGIN</button>
