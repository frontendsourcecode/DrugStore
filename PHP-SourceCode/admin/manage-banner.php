...
$folder="../assets/images/BannerImage/";
...
{
$image="assets/images/BannerImage/".$new_file;
$sql = "UPDATE banners SET name='$name',image='$image' WHERE  id='$id' ";
...
{
$id=$_GET['del'];
$query1 = $dbh->prepare("SELECT * FROM banners WHERE id= :id LIMIT 1"); 
                      ...
                      <tr>
                        ...
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal"
                          ...
                          <a href="manage-banner.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');">
